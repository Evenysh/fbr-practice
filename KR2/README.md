...
first_name
last_name
password (хешировать) (в качестве логина использовать email)
...
Необходимо доработать программу из практического занятия №8: реализуйте генерацию refresh-токенов и добавьте маршрут: POST /api/auth/refresh
...
Гость - не аутентифицированный пользователь Пользователь - пользователь сайта (только просмотр товаров) Продавец - сотрудник сайта (добавление и редактирование товаров) Администратор - управленец сайта (права продавца + управление пользователями)
